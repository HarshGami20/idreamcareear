...
const Hover = () => {
    return (
        ...
        <div className='flex relative rounded-3xl border-2 border-gray-400 m-10 overflow-hidden'>

            <div className='border-r-2 border-gray-400 group-hover:bg-white flex-grow bg-green-100 p-10 flex flex-col gap-4'>
            ...
            <div className='group transition-all duration-500 hover:flex-grow hover:bg-red-200   border-r-2 border-gray-400 w-80 p-10 flex flex-col gap-4'>
                <div className='bg-red-300 text-4xl  rounded-full w-7 h-6 p-7 '>
                    <PiGraduationCapLight className='-translate-x-[50%] -translate-y-[50%]' />
                </div>
                <h3 className='text-[var(--texth)] text-lg'>Pool of 550+ career choices</h3>
            ...
            <div className='group transition-all duration-500 hover:flex-grow hover:bg-red-200 border-r-2 border-gray-400 w-80 p-10 flex flex-col gap-4'>
                <div className='bg-red-300 text-4xl  rounded-full w-6 h-6 p-7 '>
                    <PiGraduationCapLight className='-translate-x-[50%] -translate-y-[50%]' />
                </div>
                <h3 className='text-[var(--texth)] text-lg'>Pool of 550+ career choices</h3>
                <p className='text-[var(--textgray)] text-sm'>Find the perfect career pathway thats just right for you</p>
