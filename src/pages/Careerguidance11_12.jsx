...
import SeeHow from '../components/11-12/SeeHow'
import Exploremore from '../components/11-12/Exploremore'

const Careerguidance11_12 = () => {
  return (
    <>
...
export default Careerguidance11_12